                ...
                <div class="hidden  sm:-my-px sm:mt-8 sm:flex flex-col ">
                    ...
                    <x-nav-link :href="route(auth()->user()->roleName().'.dashboard')" :active="request()->routeIs(auth()->user()->roleName().'.dashboard')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                        <div class="flex flex-row items-center gap-2">
                            ...
                            <label class=" cursor-pointer " x-show="!isMinimizeSidebar">{{ __('Overview') }}</label>
                        </div>
                    </x-nav-link>
                    </div>
                    ...
                    <div class="flex flex-col space-y-4">
                    <label class="text-grey-500 font-bold"  x-show="!isMinimizeSidebar">Admin Access</label>
                    <hr class="h-px bg-gray-500 border-1  " x-show="isMinimizeSidebar">
                            <x-nav-link :href="route('jabatan.index')" :active="request()->routeIs('jabatan.index')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                                <div class="flex felx-row items-center gap-2">
                                    ...
                                    <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('Inspector Roles') }}</label>
                                </div>
                            </x-nav-link>
                        <x-nav-link :href="route('inspektur.index')" :active="request()->routeIs('inspektur.index')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                                <div class="flex felx-row items-center gap-2">
                                    ...
                                    <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('Inspectors') }}</label>
                                </div>
                        </x-nav-link>
                    </div>
                    ...
                    <hr class="h-px bg-gray-500 border-1  " x-show="isMinimizeSidebar">
                        <x-nav-link :href="route('verifikasi.index')" :active="request()->routeIs('verifikasi.index')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                            <div class="flex felx-row items-center gap-2">
                                ...
                                <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('In Process') }}</label>
                            </div>
                        </x-nav-link>
                        <x-nav-link :href="route('admin.verifikasi.menunggu')" :active="request()->routeIs('admin.verifikasi.menunggu')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                            <div class="flex felx-row items-center gap-2">
                                ...
                                <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('Waiting List') }}</label>
                            </div>
                        </x-nav-link>   
                        <x-nav-link :href="route('verifikasi.history')" :active="request()->routeIs('verifikasi.history')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                            <div class="flex felx-row items-center gap-2">
                                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="25px">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                </svg>
                                <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('History') }}</label>
                            </div>
                        </x-nav-link>   
                    </div>        
                    @endif
                    ...
                    <label class="text-grey-500 font-bold"  x-show="!isMinimizeSidebar">Verification</label>
                    <hr class="h-px bg-gray-500 border-1  " x-show="isMinimizeSidebar">
                        <x-nav-link :href="route('dokumen.index')" :active="request()->routeIs('dokumen.index')" x-bind:class="{ 'justify-center': isMinimizeSidebar }">
                            <div class="flex felx-row items-center gap-2">
                                    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" width="25px">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z"></path>
                                    </svg>
                                    <label class=" cursor-pointer" x-show="!isMinimizeSidebar">{{ __('Document') }}</label>
                            </div>
                        </x-nav-link>
                    </div>        
                    @endif
