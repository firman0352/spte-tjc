    ...
    <head>
        ...
        <style>
            ...
            .dt-buttons .dt-button {
                ...
                outline: 2px solid transparent; /* Set the initial outline to transparent */
                outline-offset: 2px; /* Offset the outline from the element */
                outline-color: #6865EF !important; /* Set the indigo color */
                transition-duration: 50ms; /* duration-150 */
                transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1) !important; /* transition-ease-in-out */
                width: 5rem;
            }
            ...
            .dt-buttons .dt-button:focus {
                ...
                outline: 2px solid #6865EF; /* Set the indigo color on focus */
            }
        </style>
