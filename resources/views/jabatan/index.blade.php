                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                @foreach ($jabatan as $jabatan)
                                    <tr class="bg-white">
                                        ...
                                        <td
                                            class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap w-1/4 dt-body-center">
                                            ...
                                            <form action="{{ route('jabatan.destroy', $jabatan) }}" method="POST"
                                                data-id="{{ $jabatan->id }}" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button"
                                                    class="delete-button inline-flex text-red-500 items-center px-4 py-2 hover:text-red-700 disabled:opacity-25">
                                                    <svg fill="none" stroke="currentColor" stroke-width="1.5"
                                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                        aria-hidden="true" width="25px">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
