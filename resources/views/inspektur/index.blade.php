                            ...
                            <tbody class=" ">
                                @foreach($inspekturs as $inspektur)
                                    <tr class="">
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap w-1/6 dt-body-center">
                                            ...
                                            <form action="{{ route('inspektur.destroy', $inspektur) }}" method="POST" data-id="{{ $inspektur->id }}" style="display: inline-block;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button"
