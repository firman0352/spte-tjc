        ...
        <div class="modal-content py-4 text-left px-6">
            ...
            <div id="modal-body">
                <div class="flex items-center justify-between lg:flex-row flex-col">
                    ...
                    <span
                        class="px-2 py-0 lg:py-1 inline-flex text-xs lg:text-md leading-5 font-semibold rounded-full bg-yellow-100 text-yellow-800"
                ...
                <div class="flex justify-between">
                    ...
                    <div>
                        <a href="#" target="_blank" id="url-view"
                ...
                <div class="flex justify-between items-center">
                    <p class="text-black"><strong class="text-gray-400">Start date :</strong> <span id="start-date">
                            Start Date</span></p>
                    <p class="text-black"><strong class="text-gray-400">End date :</strong> <span id="end-date"> End
                            Date</span></p>
                </div>
            </div>
        </div>
