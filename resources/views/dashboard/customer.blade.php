                ...
                @if (auth()->user()->dokumenCustomer->status_id == 3)
                    <div class="p-6 flex items-center gap-3 text-indigo-500 mt-2">
                        ...
                        <div class="flex flex-col gap-2 items-center">
                            <p class="text-2xl text-center font-bold text-green-500">Your documents have been verified
                            </p>
                            <p class="text-md text-center">Your documents have been verified, make a transaction now.
                            </p>
    ...
    <div class="flex flex-col md:flex-row gap-10 mt-10 w-full">
        ...
        <div class="flex flex-col gap-5 md:w-3/5">
            ...
            @if ($signContract)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg py-4 px-10">
                    <a href="{{ route('orders.index') }}" class="text-black flex justify-between items-center">
                        <div class="py-2 gap-4 items-center flex">
                            <span class="bg-yellow-500  rounded-full px-3 py-1 text-white">{{ $signContract }}</span>
                            <span>
                                @if ($signContract == 1)
                                    Order need you to sign a contract first for the order to be processed.
                                @else
                                    Orders need you to sign a contract first for the order to be processed.
                                @endif
                            </span>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
            ...
            @if ($firstPayment)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg py-4 px-10">
                    <a href="{{ route('orders.index') }}" class="text-black flex justify-between items-center">
                        <div class="py-2 gap-4 items-center flex">
                            <span class="bg-yellow-500  rounded-full px-3 py-1 text-white">{{ $firstPayment }}</span>
                            <span>
                                @if ($firstPayment == 1)
                                    Order must be paid for term 1 before proceeding to the next process
                                @else
                                    Orders must be paid for term 1 before proceeding to the next process.
                                @endif
                            </span>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
            ...
            @if ($secondPayment)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg py-4 px-10">
                    <a href="{{ route('orders.index') }}" class="text-black flex justify-between items-center">
                        <div class="py-2 gap-4 items-center flex">
                            <span class="bg-yellow-500  rounded-full px-3 py-1 text-white">{{ $secondPayment }}</span>
                            <span>
                                @if ($secondPayment == 1)
                                    Order must be paid for term 2 before proceeding to the next process
                                @else
                                    Orders must be paid for term 2 before proceeding to the next process.
                                @endif
                            </span>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
            ...
            @if ($thirdPayment)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg py-4 px-10">
                    <a href="{{ route('orders.index') }}" class="text-black flex justify-between items-center">
                        <div class="py-2 gap-4 items-center flex">
                            <span class="bg-yellow-500  rounded-full px-3 py-1 text-white">{{ $thirdPayment }}</span>
                            <span>
                                @if ($thirdPayment == 1)
                                    Order must be paid for term 3 before proceeding to the next process.
                                @else
                                    Orders must be paid for term 3 before proceeding to the next process.
                                @endif
                            </span>
                        </div>
                        <svg xmlns="http://www.w3.org/2000/svg" height="1em"
            ...
            @if ($ordersArrived)
                <div class="bg-white overflow-hidden shadow-sm rounded-lg py-4 px-10">
                    <a href="{{ route('orders.index') }}" class="text-black flex justify-between items-center">
                        <div class="py-2 gap-4 items-center flex">
                            <span class="bg-yellow-500  rounded-full px-3 py-1 text-white">{{ $ordersArrived }}</span>
                            <span>
                                @if ($ordersArrived == 1)
                                    Order has reached its destination, check the product and complete the transaction
                                    immediately.
                                @else
                                    Orders has reached its destination, check the product and complete the transaction
                                    immediately.
                                @endif
                            </span>
                        </div>
