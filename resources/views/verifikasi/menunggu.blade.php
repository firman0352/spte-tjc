                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                @foreach ($dokumen as $item)
                                    <tr class="bg-white">
                                        ...
                                        <td
                                            class="px-6 py-4 text-sm  leading-5 text-gray-900 whitespace-no-wrap w-1/5 dt-body-center">
                                            ...
                                            <form action="{{ route('admin.verifikasi.tolak', ['dokumen' => $item]) }}"
                                                method="POST" data-dokumen-id="{{ $item->id }}"
                                                style="display: inline-block;">
                                                @csrf
                                                @method('PUT')
                                                <button type="button"
                                                    class="decline-button px-2 py-0 lg:py-1 inline-flex items-center text-sm lg:text-md leading-5 font-semibold rounded-full bg-pink-100 text-pink-800 gap-1 hover:bg-pink-200 hover:text-pink-900">
                                                    <svg fill="none" stroke="currentColor" stroke-width="1.5"
                                                        viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                                        aria-hidden="true" width="12px">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
