...
<x-app-layout>
    ...
    <x-verif-details-modal>
        ...
        <p class="mb-2 text-black"><strong class="text-gray-400">Address:</strong> <span id="inspector1/address">Address</span></p>
        <p class="mb-2 text-black"><strong class="text-gray-400">Phone Number:</strong> <span id="inspector2/phone">Phone</span></p>
        </x-slot>
    </x-verif-details-modal>
    <div>
</div>
                    ...
                    <div class="min-w-full align-middle">
                        <table id="listTable" class=" nowrap hover compact">
                            ...
                            <tr>
                                ...
                                <th class="bg-transparant px-6 py-3 text-left">
                                    <span class="text-xs font-bold uppercase leading-4 tracking-wider text-black">Address</span>
                                </th>
                                <th class="bg-transparant px-6 py-3 text-left">
                                    <span class="text-xs font-bold uppercase leading-4 tracking-wider text-black">Phone Number</span>
                                </th>
                                <th class="bg-transparant px-6 py-3 text-left">
                                ...
                                <th class="w-56 bg-transparant px-6 py-3 text-left dt-head-center">
                                    <span class="text-xs font-bold uppercase leading-4 tracking-wider text-black ">View</span>
                                </th>
                            </tr>
                            </thead>
