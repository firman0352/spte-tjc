                    ...
                    <div class="min-w-full align-middle">
                        <table id="listTable" class=" nowrap hover compact">
                            ...
                            <tr>
                                ...
                                <th class="bg-gray-50 px-6 py-3 text-left">
                                    <span class="text-xs font-bold uppercase leading-4 tracking-wider text-black">Second Inspector</span>
                                </th>
                                @elseif(auth()->user()->inspektur->jabatan_id == 2)
                                <th class="bg-gray-50 px-6 py-3 text-left">
                                    <span class="text-xs font-bold uppercase leading-4 tracking-wider text-black">Fisrt Inspector</span>
                                </th>
                                @endif
                                <th class="bg-gray-50 px-6 py-3 text-left">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 divide-solid">
                                @foreach($verifikasi as $item)
                                    <tr class="bg-white">
                                        <td class="px-6 py-4 text-sm font-semibold leading-5 text-black whitespace-no-wrap">
                                        ...
                                        <td class="px-6 py-4 text-sm leading-5 text-gray-900 whitespace-no-wrap dt-body-center">
